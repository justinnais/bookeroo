...
public class ReviewService {
    ...
    public Review postReview(Review review) throws DuplicateReviewException, BadReviewScoreException, BadReviewTextException {
        ...
        if (review.getReview().length() > Review.MAX_LENGTH) {
            throw new BadReviewTextException("Review is too long, must be less than 240 characters");
        }
